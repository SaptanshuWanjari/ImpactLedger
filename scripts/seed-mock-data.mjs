...
async function run() {
  ...
  const campaignRows = [
    {
      ...
      description: "Solar boreholes and sanitation training for underserved communities.",
    ...
    {
      tenant_id: tenantId,
      title: "Cyclone Emergency Relief",
      description: "Rapid deployment of food, medicine, and shelters after severe cyclone impact.",
    ...
    },
    {
      ...
      description: "Scholarships, teacher support, and school materials for rural students.",
      category: "Education",
      location: "India",
    ...
    {
      tenant_id: tenantId,
      title: "Rural Mobile Health Clinics",
      description: "Deploying mobile primary care units to remote regions.",
      category: "Healthcare",
      location: "Nepal",
    ...
    },
    {
      ...
      description: "Native tree restoration and environmental stewardship with local schools.",
    ...
    {
      tenant_id: tenantId,
      title: "Women Skills Accelerator",
      description: "Vocational training and micro-enterprise support for women collectives.",
      category: "Livelihood",
      location: "India",
  ...
  const donorRows = [
    { full_name: "John Doe", email: roleEmails.donor, phone: "+91-9000000001", communications_opt_in: true, is_anonymous: false },
    { full_name: "Sarah Smith", email: roleEmails.volunteer, phone: "+91-9000000002", communications_opt_in: true, is_anonymous: false },
    ...
    { full_name: "Global Aid Foundation", email: "grants@globalaid.org", phone: "+1-202-555-0191", communications_opt_in: true, is_anonymous: false },
    { full_name: "Anonymous Corporate", email: "csr@northstar.com", phone: "+1-202-555-0176", communications_opt_in: true, is_anonymous: true },
    { full_name: "Leena Joseph", email: "leena@example.com", phone: "+91-9000000005", communications_opt_in: true, is_anonymous: false },
    { full_name: "David Kim", email: "david@example.com", phone: "+1-202-555-0143", communications_opt_in: false, is_anonymous: false },
  ].map((donor) => ({
    tenant_id: tenantId,
    ...donor,
  ...
  const donationTemplates = [
    { donorEmail: roleEmails.donor, campaignTitle: "Clean Water Initiative", amount: 25000, status: "succeeded", paymentMethod: "Visa •••• 4242", daysAgo: 2 },
    { donorEmail: roleEmails.donor, campaignTitle: "Cyclone Emergency Relief", amount: 40000, status: "succeeded", paymentMethod: "UPI", daysAgo: 10 },
    { donorEmail: roleEmails.donor, campaignTitle: "Youth Education Fund", amount: 18000, status: "refunded", paymentMethod: "Visa •••• 4242", daysAgo: 24, refundedAmount: 18000 },
    { donorEmail: roleEmails.volunteer, campaignTitle: "Rural Mobile Health Clinics", amount: 12000, status: "succeeded", paymentMethod: "NetBanking", daysAgo: 5 },
    { donorEmail: "arjun@example.com", campaignTitle: "Cyclone Emergency Relief", amount: 90000, status: "disputed", paymentMethod: "Mastercard •••• 7788", daysAgo: 8, disputeStatus: "needs_response" },
    { donorEmail: "priya@example.com", campaignTitle: "Clean Water Initiative", amount: 15000, status: "failed", paymentMethod: "UPI", daysAgo: 11, failureReason: "insufficient_funds" },
    { donorEmail: "grants@globalaid.org", campaignTitle: "Youth Education Fund", amount: 250000, status: "succeeded", paymentMethod: "Bank Transfer", daysAgo: 35 },
    { donorEmail: "csr@northstar.com", campaignTitle: "Rural Mobile Health Clinics", amount: 320000, status: "succeeded", paymentMethod: "Wire Transfer", daysAgo: 42 },
    { donorEmail: "leena@example.com", campaignTitle: null, amount: 11000, status: "pending", paymentMethod: "UPI", daysAgo: 1 },
    { donorEmail: "david@example.com", campaignTitle: "Community Reforestation", amount: 8000, status: "failed", paymentMethod: "Card", daysAgo: 16, failureReason: "card_declined" },
    { donorEmail: "priya@example.com", campaignTitle: "Cyclone Emergency Relief", amount: 22000, status: "succeeded", paymentMethod: "UPI", daysAgo: 52 },
    { donorEmail: "leena@example.com", campaignTitle: "Youth Education Fund", amount: 7000, status: "succeeded", paymentMethod: "Wallet", daysAgo: 60 },
    { donorEmail: "arjun@example.com", campaignTitle: "Clean Water Initiative", amount: 10000, status: "succeeded", paymentMethod: "NetBanking", daysAgo: 72 },
    { donorEmail: "grants@globalaid.org", campaignTitle: "Cyclone Emergency Relief", amount: 300000, status: "succeeded", paymentMethod: "Bank Transfer", daysAgo: 88 },
    { donorEmail: "david@example.com", campaignTitle: "Women Skills Accelerator", amount: 12000, status: "succeeded", paymentMethod: "Card", daysAgo: 102 },
    { donorEmail: roleEmails.donor, campaignTitle: null, amount: 5000, status: "succeeded", paymentMethod: "UPI", daysAgo: 118 },
    { donorEmail: "priya@example.com", campaignTitle: "Women Skills Accelerator", amount: 6000, status: "succeeded", paymentMethod: "Wallet", daysAgo: 133 },
    { donorEmail: "arjun@example.com", campaignTitle: "Rural Mobile Health Clinics", amount: 8500, status: "succeeded", paymentMethod: "UPI", daysAgo: 146 },
    { donorEmail: "david@example.com", campaignTitle: "Community Reforestation", amount: 4500, status: "pending", paymentMethod: "Card", daysAgo: 0 },
  ];
  ...
  const expenseRows = [
    ...
    {
      tenant_id: tenantId,
      campaign_id: campaignMap["Cyclone Emergency Relief"].id,
    ...
    {
      tenant_id: tenantId,
      campaign_id: campaignMap["Rural Mobile Health Clinics"].id,
    ...
    {
      tenant_id: tenantId,
      campaign_id: campaignMap["Women Skills Accelerator"].id,
  ...
  const volunteerRows = [
    ...
    },
    {
      ...
      skills: ["coordination", "dispatch", "operations"],
    ...
    },
    {
      ...
      skills: ["health-screening", "data-collection"],
      certifications_count: 2,
      hours_logged: 67,
      impact_score: 89,
    },
  ...
  const assignmentRows = [
    ...
    },
    {
      ...
      location: "Kathmandu Mobile Unit",
      priority: "medium",
      status: "assigned",
  ...
  const auditRows = [
    {
      ...
      target_id: campaignMap["Cyclone Emergency Relief"].id,
      metadata: { seeded: true, category: "Disaster Relief" },
