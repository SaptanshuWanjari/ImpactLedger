...
export default function LandingPage() {
  const { data, isLoading } = useApiData<OverviewResponse>(
    "/api/public/overview",
  );
        ...
        <section className="no-line-card mx-25 mt-25 mb-20 p-16 bg-accent text-white text-center space-y-8 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-8 relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/donate"
                className="btn-primary bg-white text-accent border-none py-4 px-10 text-lg"
              >
                Donate Now
              </Link>
              <Link
                href="/volunteer"
                className="btn-outline border-white text-white hover:bg-white hover:text-accent py-4 px-10 text-lg"
              >
                Volunteer Hub
              </Link>
            </div>
