      ...
      <main className="flex-grow pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto space-y-32">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                LNMS (Lions NGO Management System) is a radical departure from traditional charity. We replace vague promises with immutable data and real-time verification.
              </p>
              <div className="flex gap-4">
                <Link href="/transparency" className="btn-primary py-4 px-8">
                  Explore the Ledger
                </Link>
                <Link href="/campaigns" className="btn-outline py-4 px-8">
                  View Missions
                </Link>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 p-8 bg-white rounded-3xl shadow-2xl space-y-4 max-w-xs border border-muted">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="no-line-card p-12 space-y-6 bg-primary text-primary-foreground">
              <div className="w-12 h-12 bg-accent text-white rounded-2xl flex items-center justify-center">
                <Target size={24} />
              </div>
              <h2 className="text-4xl font-display font-extrabold tracking-tight">Our Mission</h2>
            ...
            <div className="no-line-card p-12 space-y-6 border border-muted">
              <div className="w-12 h-12 bg-accent/10 text-accent rounded-2xl flex items-center justify-center">
                <Award size={24} />
              </div>
              <h2 className="text-4xl font-display font-extrabold tracking-tight">Our Vision</h2>
          ...
          <section className="space-y-16">
            <div className="text-center space-y-4 max-w-2xl mx-auto">
              <h2 className="text-4xl md:text-6xl font-display font-extrabold tracking-tight">The LNMS Principles.</h2>
          ...
          <section className="space-y-16">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground max-w-xl">Meet the engineers, humanitarians, and visionaries building the future of LNMS.</p>
              </div>
          ...
          <section className="no-line-card p-16 bg-accent text-white text-center space-y-8 relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto space-y-8 relative z-10">
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Join thousands of donors and volunteers who are already using LNMS to build a more transparent world.
              </p>
