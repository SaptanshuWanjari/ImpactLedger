        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using the LNMS (Lions NGO Management System) platform, you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use our services.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              All donations made through LNMS are final and non-refundable. We are committed to radical transparency and will provide verifiable proof of fund allocation for every donation.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Volunteers are responsible for providing accurate field reports and following our safety and ethical guidelines. LNMS reserves the right to terminate volunteer assignments at any time.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              LNMS shall not be liable for any direct, indirect, incidental, or consequential damages arising out of your use of the platform.
            </p>
          </section>
