        ...
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-extrabold tracking-tighter leading-none">
              Connect with <br />
              <span className="text-accent">Impact Ledger.</span>
            </h1>
            ...
            <section className="space-y-12">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {[
                  ...
                  { title: "Call Us", value: "+1 (800) 555-Impact Ledger", icon: Phone, color: "bg-green-50 text-green-600" },
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    "Is my data secure on the Impact Ledger ledger?",
                  ].map((q) => (
              ...
              <div className="no-line-card p-8 bg-primary text-primary-foreground rounded-3xl space-y-4">
                ...
                <p className="text-sm text-primary-foreground/70 leading-relaxed">
                  Impact Ledger is committed to 100% transparency. If you have any concerns about fund allocation or impact verification, please contact our transparency officer directly.
                </p>
                <button className="text-xs font-bold text-blue-400 uppercase tracking-widest hover:underline flex items-center gap-2">
