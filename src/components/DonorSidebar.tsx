      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur border-b border-muted">
        <div className="h-16 px-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-display font-extrabold tracking-tight">Donor Portal</span>
          </div>
          <button
            type="button"
            onClick={() => setIsOpen((value) => !value)}
            className="p-2 text-primary"
            aria-label="Toggle donor menu"
        ...
        <div className="lg:hidden fixed inset-0 z-40 bg-black/35" onClick={closeMenu}>
          ...
          >
            <nav className="space-y-2">
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-4 px-3">Donor Menu</p>
